            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      class="pt "
                      @click="changeImage(tumbs[0])"
                      :class="tumbs[0] === gambar_default ? 'active' : ''"
                    >
                      <img src="img/mickey1.jpg" alt="" />
                    </div>
                    <div
                      class="pt "
                      @click="changeImage(tumbs[1])"
                      :class="tumbs[1] === gambar_default ? 'active' : ''"
                    >
                      <img src="img/mickey2.jpg" alt="" />
                    </div>
                    <div
                      class="pt "
                      @click="changeImage(tumbs[2])"
                      :class="tumbs[2] === gambar_default ? 'active' : ''"
                    >
                      <img src="img/mickey3.jpg" alt="" />
                    </div>
                    <div
                      class="pt "
                      @click="changeImage(tumbs[3])"
                      :class="tumbs[3] === gambar_default ? 'active' : ''"
                    >
              ...
              <div class="col-lg-6 text-left">
                <div class="product-details">
                  ...
                  <div class="quantity">
                    <router-link to="/check_out" class="primary-btn pd-cart"
